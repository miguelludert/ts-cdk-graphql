...
import { AuthorizationMode, GraphqlApi } from "@aws-cdk/aws-appsync";
...
export interface I_DatasourceProvider {
    ...
    createResources: (scope: Construct, props: I_AppSyncGqlSchemaProps, api: GraphqlApi, cfSchema: any) => I_ConstructMap | void;
}
